<template>
  ...
  <div class="page-content">
    <v-card elevation="2" class="font-montserrat px-6 pt-3 pb-5 rounded-lg account-card">
      ...
      <v-btn class="font-montserrat text-capitalize font-weight-bold font-large bg-primary" @click="handleSubmit">
        Continuar
      </v-btn>
    </v-card>
  </div>
...
<script setup>
  ...
  const handleSubmit = () => {
    emit("set-data", { newAmount: monto.value, newTo: inputValue.value, newMethod: getMethod() });
  }
